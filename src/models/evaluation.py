...
dagshub.init(repo_owner='shanu202000', repo_name='swiggy-delivery-time-prediction', mlflow=True)


# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/shanu202000/swiggy-delivery-time-prediction.mlflow")
...
if __name__ == "__main__":
    ...
    with mlflow.start_run() as run:
        ...
        logger.info("STARTING MLflow LightGBM model logging...")
        ...
        logger.info("MLflow LightGBM model logging COMPLETED")
